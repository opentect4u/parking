...
const { general_settings, receipt_setting, rate_dtls_list, gst_list, fixed_rate_dtls_list, my_shift } = require('../../controller/api/V8/Master.controller');
const { car_in, search_car, out_pass, car_in_fixed, car_advance_amount, car_in_out } = require('../../controller/api/V8/CarInCarOut.controller');
