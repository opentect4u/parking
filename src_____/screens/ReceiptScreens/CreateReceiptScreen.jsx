...
import { useBluetoothPrint_N } from "../../hooks/printables/useBluetoothPrint_N"
// hooks/printables/useBluetoothPrint
...
const CreateReceiptScreen = ({ navigation, route }) => {
  ...
  const { getDevice_type } = useContext(AuthContext);
  ...
  const { printCollectionReport } = useBluetoothPrint_N();
  ...
  useEffect(() => {
    // console.log(getDevice_type, 'getDevice_typegetDevice_typegetDevice_typegetDevice_type');
    getVehicleRateFixedByVehicleId(dev_mod, id);
  }, []);
  ...
  // const handleCreateReceipt__test = async () => {
  //   var fromDate = '02/04/2024';
  //   var toDate = '15/04/2024';
  //   // var companyId = 100;
  //   // var branchId = 200;
  //   // var userId = 'user_102';
  //   var collectionReport = [];
  //   printCollectionReport(collectionReport, fromDate, toDate); 
  //   // console.log(loginData, 'rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr');
        ...
        <View style={{ padding: PixelRatio.roundToNearestPixel(30) }}>
          ...
          <View
            ...
            {/* {getDevice_type == "M" (
              ...
              title={"Print Receipt xxx"}
              onAction={() => handleCreateReceipt__test()}
